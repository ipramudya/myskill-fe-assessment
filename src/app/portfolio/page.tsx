				...
				<div className="flex justify-between">
					...
					<div className="flex flex-col space-y-3">
						<div className="flex flex-col">
							...
							<h3 className="text-base font-normal text-black-low">Jabatan</h3>
						</div>
						<p className="text-sm md:max-w-[60%]">
							Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea laborum non,
							accusantium repellat porro vitae aspernatur necessitatibus quidem sint
							voluptate!
						</p>
					</div>
			...
			<Section>
				<div className="flex flex-col space-y-3">
					<h2 className="text-lg">
						Portofolio <span className="text-sm font-normal text-gray">(2 item)</span>
					</h2>
